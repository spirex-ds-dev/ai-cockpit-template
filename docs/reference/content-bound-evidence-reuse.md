...
status: reference
authority: canonical
lastVerifiedBy: wi-08-content-bound-reuse-tests
capabilityClaims:
...
WI-08 adds the content-specific policy on top of the versioned WI-07 binding
...
optional `baseCommit` is informational and is ignored by this policy. The
