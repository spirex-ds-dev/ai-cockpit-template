...
| 发布前过期资产清理 | 历史 `pre-release-deprecated-assets-cleanup-20260730` 内容已直接进入 main，但无可验证 PR 生命周期；当前 `pre-release-deprecated-assets-lifecycle-audit-20260730` 重新验证资产安全、明确该历史限制，并以独立 PR 闭环。 |
