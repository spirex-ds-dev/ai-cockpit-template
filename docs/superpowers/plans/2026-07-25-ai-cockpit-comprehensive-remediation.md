...
| 文档对齐 | 历史 `pre-release-documentation-alignment-20260729` 停在旧基线且未交付；当前 `documentation-alignment-ruff-ci-corrective-20260730` 从最新 `origin/main` 重建源绑定审计，并以 Hosted Ruff 0.16 兼容性作为发布前条件。 |
