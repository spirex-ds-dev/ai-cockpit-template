...
V2.5 の Cockpit は Summary をそのまま複製せず、`reviewReadiness`、`residualRisks`、`verification`、`guidelinesCompliance`、`checkpointEvidence`、`intentAlignment` を圧縮して Human Decision State を生成します。
