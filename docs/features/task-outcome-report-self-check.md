...
- RFE-097 makes Outcome generation mandatory for future code-mode Work Items, binds truthful pre-merge facts before archive, and requires a validated post-merge Closure Receipt before branch cleanup.
...
- Historical Work Items are not backfilled; their archive evidence remains immutable.
