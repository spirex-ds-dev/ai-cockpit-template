...
description: "The shortest current path from installation evidence to a reviewed Project Profile."
audience:
  - adopter
status: current
authority: canonical
...
3. Run `make cockpit-doctor` and review its repository evidence.
4. Select the proportional [Calibration Profile](../reference/calibration-profiles.md).
5. Resolve every blocking Unknown and obtain the required human confirmation.
6. Validate the Project Profile and run the selected quality route.
