...
def test_repository_source_version_matches_the_current_candidate():
    ...
    assert candidate["releaseTag"] == f"v{version['releaseVersion']}"
    assert preflight.validate_source_release_version(version, candidate["releaseTag"]) == []
