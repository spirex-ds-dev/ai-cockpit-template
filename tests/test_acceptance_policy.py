...
def test_acceptance_policy_covers_missing_verification_and_ready():
    ...
    assert acceptance_signal(contract,{"reviewReadiness":{"status":"ready"}},{"value":"incomplete"})["value"] == "incomplete"
    assert acceptance_signal(contract,{"reviewReadiness":{"status":"ready"}},{"value":"passed"})["value"] == "complete"
