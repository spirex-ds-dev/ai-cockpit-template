...
| Preflight Review | Work Item Contract の既存証拠から implementation 前の readiness を派生する助言的ビュー。AI の自己申告ではなく、Intent / Unknowns / Sources / Acceptance / Scope / OutOfScope / Scenario Coverage / Verification を根拠にする。 |
