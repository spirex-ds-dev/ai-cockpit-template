...
Task projection-isolation-664 generated an evidence-derived outcome with status completed_with_warnings.
...
- Unresolved evidence is explicitly limited: Governed Finish/archive lifecycle remains required; the valid full quality session is recorded above.
