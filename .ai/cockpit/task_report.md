...
Task multilingual-semantic-parity generated an evidence-derived outcome with status completed_with_warnings.
...
- Unresolved evidence is explicitly limited: General translation equivalence remains intentionally out of scope.
