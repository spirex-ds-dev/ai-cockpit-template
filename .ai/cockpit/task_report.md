...
Task enterprise-control-evidence-model generated an evidence-derived outcome with status completed_with_warnings.
...
- Unresolved evidence is explicitly limited: No external provider or enterprise evidence was supplied because configuration and external verification are out of scope.
