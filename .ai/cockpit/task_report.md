...
Task human-report-semantic-quality generated an evidence-derived outcome with status completed_with_warnings.
...
- Unresolved evidence is explicitly limited: The report is an evidence projection, not external-control, safety, or human-receipt proof.
