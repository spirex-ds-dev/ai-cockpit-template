...
Task historical-worktree-cleanup generated an evidence-derived outcome with status completed_with_warnings.
...
- Unresolved evidence is explicitly limited: One dirty historical worktree is intentionally preserved and requires a separate reconciliation Work Item; do not claim all physical worktree remnants are removed.
