...
Task lockfile-reproducibility-725 generated an evidence-derived outcome with status completed_with_warnings.
...
- Unresolved evidence is explicitly limited: Fresh official hosted verification awaits the delivery PR; no hosted evidence is claimed before that run completes.
