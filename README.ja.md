...
AI Cockpit は、AI 支援開発に軽量なガバナンスを追加します。

![AI Cockpit demo](docs/assets/ai-cockpit-demo.gif)

**AI は単なるコーディングツールではありません。AI は production participant です。**

AI Cockpit は、AI が生成した変更を境界付き、レビュー可能、監査可能にします。

AI 生成変更に Git 的な規律を与える、小さな制御層だと考えてください。scope、checks、summary、status を中心に制御します。
