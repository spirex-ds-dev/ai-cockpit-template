...
MANDATORY_EVIDENCE_CHECKS = ("capabilityTruth",)
...
def run_mandatory_evidence_checks(
    *,
    ...
    """Fail closed on repository evidence that must be current at finish.

    This intentionally does not depend on a Contract's optional quality entry:
    a skipped broad quality run must not let source-bound Capability Truth drift
    reach an Outcome, archive, or hosted CI.
    """
