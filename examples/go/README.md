...
```sh
AI_COCKPIT_TEMPLATE_REF=v0.5.22 sh -c "$(curl -fsSL https://raw.githubusercontent.com/xinglun/ai-cockpit-template/v0.5.22/install.sh)" -- --stack go --update-makefile --create-adoption
```
