...
```sh
AI_COCKPIT_TEMPLATE_REF=v0.5.17 sh -c "$(curl -fsSL https://raw.githubusercontent.com/xinglun/ai-cockpit-template/v0.5.17/install.sh)" -- --stack rust --update-makefile --create-adoption
```
