...
```sh
AI_COCKPIT_TEMPLATE_REF=v0.5.18 sh -c "$(curl -fsSL https://raw.githubusercontent.com/xinglun/ai-cockpit-template/v0.5.18/install.sh)" -- --stack java --update-makefile --create-adoption
```
