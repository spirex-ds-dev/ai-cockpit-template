...
```sh
AI_COCKPIT_TEMPLATE_REF=v0.5.12 sh -c "$(curl -fsSL https://raw.githubusercontent.com/xinglun/ai-cockpit-template/v0.5.12/install.sh)" -- --stack typescript --update-makefile --create-adoption
```
