...
```sh
AI_COCKPIT_TEMPLATE_REF=v0.5.19 sh -c "$(curl -fsSL https://raw.githubusercontent.com/xinglun/ai-cockpit-template/v0.5.19/install.sh)" -- --stack php --update-makefile --create-adoption
```
