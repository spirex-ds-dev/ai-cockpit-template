...
```sh
AI_COCKPIT_TEMPLATE_REF=v0.5.21 sh -c "$(curl -fsSL https://raw.githubusercontent.com/xinglun/ai-cockpit-template/v0.5.21/install.sh)" -- --stack csharp --update-makefile --create-adoption
```
