...
```sh
AI_COCKPIT_TEMPLATE_REF=v0.5.15 sh -c "$(curl -fsSL https://raw.githubusercontent.com/xinglun/ai-cockpit-template/v0.5.15/install.sh)" -- --stack flutter --update-makefile --create-adoption
```
